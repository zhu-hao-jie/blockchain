...
echo "八、创建制造商与订单数据"
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createReceiver","E1","Tu,Br,Gt,Ty"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createReceiver","E2","Bu,Bt,Gt,Ty"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createReceiver","E3","Gt,Br,Gn,Ta"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createReceiver","E4","Ct,Sa,Gt,Ty"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createReceiver","E5","Mi,Dr,Gr,Rea"]}'

docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createOrderStr","Enterprise1","Grinding","noStart","20220907"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createOrderStr","Enterprise2","Turning","noStart","20221112"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createOrderStr","Enterprise3","Milling","done","20220403"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createOrderStr","Enterprise4","Shaping","noStart","20220529"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["createOrderStr","Enterprise5","Sawing","done","20220619"]}'

#echo "建立匹配过程"
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["doMatch","De,Tr","Turn,De,Mo,Ty,Tu"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["doMatch","De,Mo,Ty","Saw,De,Mo,Ty,Fr"]}'
...
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["queryReceiverRes"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["queryOrderStr"]}'
echo "通过peer0查询"
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["queryReceiverRes"]}'
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["queryOrderStr"]}'
...
echo "查询匹配结果"
docker exec cli peer chaincode invoke -C assetschannel -n blockchain-real-estate -c '{"Args":["queryDoMatch"]}'
