...
func InitRouter() *gin.Engine {
	...
	apiV1 := r.Group("/api/v1")
	{
		...
		apiV1.GET("/queryRealEstateList", v1.QueryReceiverRes)
		apiV1.POST("/createSelling", v1.CreateSelling)
		apiV1.POST("/createSellingByBuy", v1.CreateSellingByBuy)
		apiV1.GET("/querySellingList", v1.QuerySellingList)
		...
		apiV1.GET("/queryOrderList", v1.QueryOrderList)
		apiV1.GET("/queryOrderHistory", v1.QueryOrderHistory)
		//********************************************************************//
		apiV1.GET("/queryPlusAccountList", v1.QueryPlusAccountList)
		apiV1.POST("/createReceiver", v1.CreateReceiver)
		apiV1.GET("/queryReceiverRes", v1.QueryReceiverRes)
		apiV1.POST("/createOrderStr", v1.CreateOrderStr)
		apiV1.GET("/queryOrderStr", v1.QueryOrderStr)
		apiV1.POST("/updateOrderStr", v1.UpdateOrderStr)
		apiV1.GET("/queryDoMatch", v1.QueryDoMatch)
		apiV1.POST("/doMatch", v1.QueryMatch)
	}
	// 静态文件路由
